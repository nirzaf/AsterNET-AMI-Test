...
namespace AsterNET_AMI_Test
{
    internal static class Program
    {
        private const string DEV_HOST = "192.168.2.34";
        private const int ASTERISK_PORT = 5038;
        private const string ASTERISK_HOST = "fazrin.voippabx.com.au";
        private const string ASTERISK_LOGINNAME = "9SDBfQFTStKT";
        private const string ASTERISK_LOGINPWD = "03HUCVw3QGcx";

        private const string ORIGINATE_CONTEXT = "bbs-pabx";
        private const string ORIGINATE_CHANNEL = "SIP/9002";
        private const string ORIGINATE_EXTRA_CHANNEL = "SIP/9003";
        private const string ORIGINATE_EXTRA_EXTEN = "9001";
        private const string ORIGINATE_EXTEN = "9002";
        private const string ORIGINATE_CALLERID = "9002";
        private const int ORIGINATE_TIMEOUT = 15000;
        ...
        //private static void manager_IgnoreEvent(object sender, NewExtenEvent e)
        //{
        //    Console.WriteLine(e);
        //}

        #endregion checkManagerAPI()

        #region Event handlers

        private static void dam_Events(object sender, ManagerEvent e)
        {
            Console.WriteLine("Dam Event " + e);
        }

        //private static void dam_Reload(object sender, ReloadEvent e)
        //{
        //    Console.WriteLine(string.Format("\nReload Event: {0}", e.Message));
        //}

        //private static void dam_Link(object sender, LinkEvent e)
        //{
        ...
        //private static void dam_ExtensionStatus(object sender, ExtensionStatusEvent e)
        //{
        ...
        //private static void dam_Dial(object sender, DialEvent e)
        //{
        //    Console.WriteLine(
        //        "Dial Event"
        //        + "\n\tCallerId\t" + e.CallerId
        ...
        private static void dam_Hangup(object sender, HangupEvent e)
        {
        ...
        private static void dam_NewExten(object sender, NewExtenEvent e)
        {
            Console.WriteLine(
                "New Extension Event"
                + "\n\tChannel\t\t" + e.Channel
        ...
        private static void dam_NewChannel(object sender, NewChannelEvent e)
        {
        ...
        private static void dam_PeerStatus(object sender, PeerStatusEvent e)
        {
        ...
        private static void dam_UserEvents(object sender, UserEvent e)
        {
